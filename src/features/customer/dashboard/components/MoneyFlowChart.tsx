...
const MoneyFlowChart: React.FC = () => {
  ...
  //   { time: "2019-03", count: 87, type: "transactions" },
  //   { time: "2019-04", count: 100, type: "transactions" },
  //   { time: "2019-05", count: 200, type: "transactions" },
  //   { time: "2019-06", count: 50, type: "transactions" },
  //   { time: "2019-07", count: 10, type: "transactions" },
  // ];
